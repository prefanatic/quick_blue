...
class PlatformCompanionDevice {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(id, other.id) && _deepEquals(name, other.name) && _deepEquals(associationId, other.associationId);
  }
...
class QuickBlueApi {
  ...
  Future<PlatformCompanionDevice?> companionAssociate({String? deviceId, List<String>? serviceUuids, Map<int, Uint8List>? manufacturerData, }) async {
    ...
    ;
    return pigeonVar_replyValue as PlatformCompanionDevice?;
  }
  ...
  Future<List<PlatformCompanionDevice>> getCompanionAssociations() async {
    ...
    ;
    return (pigeonVar_replyValue! as List<Object?>).cast<PlatformCompanionDevice>();
  }
